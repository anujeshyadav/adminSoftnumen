  ...
  async componentDidMount() {
    ...
    await CreatedOrderList()
      ...
      .then((res) => {
        ...
        let CreatAccountView = JSON.parse(jsonData)?.createOrder;
        ...
        let userHeading = JSON.parse(localStorage.getItem("OrderSearch"));
        ...
        <Row className="app-user-list">
          {this.state.EditOneUserView && this.state.EditOneUserView ? (
            <Row className="card">
              ...
              <EditOrder EditOneData={this.state.EditOneData} />
            </Row>
          ) : (
            <>
